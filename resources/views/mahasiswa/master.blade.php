                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="/mahasiswa/hari">Data Hari</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/ruang_kelas">Data Ruang Kelas</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/krs">Data KRS</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/mahasiswa">Data Mahasiswa</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/dosen">Data Dosen</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/matakuliah">Data Matakuliah</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/prodi">Data Prodi</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="/mahasiswa/dosen_pengampu">Data Dosen Pengampu</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="/mahasiswa/laporan_mahasiswa">Laporan Data Mahasiswa</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/laporan_dosen">Laporan Data Dosen</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/laporan_matakuliah">Laporan Data Matakuliah</a>
                                    </li>
                                    <li>
                                        <a href="/mahasiswa/laporan_dosen_pengampu">Laporan Data Dosen Pengampu</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
